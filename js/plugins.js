  ...
  var c = {
    ...
    transitionStart: function (e, t) {
      ...
      if (!s.cssMode) {
        ...
        var r = t
        if (
          (r || (r = i > a ? "next" : i < a ? "prev" : "reset"), this.emit("transitionStart"), e && i !== a)
        ) {
    ...
    transitionEnd: function (e, t) {
      ...
      if (((this.animating = !1), !a.cssMode)) {
        ...
        var r = t
        if (
          (r || (r = i > s ? "next" : i < s ? "prev" : "reset"), this.emit("transitionEnd"), e && i !== s)
        ) {
    ...
    if ((l.originalEvent && (l = l.originalEvent), i.isTouched)) {
      if (!i.isTouchEvent || "mousemove" !== l.type) {
        ...
        if (
          ...
          if (
            !(this.params.threshold && Math.sqrt(Math.pow(c, 2) + Math.pow(u, 2)) < this.params.threshold)
          ) {
            var v
      ...
      if (s.freeMode) {
        ...
        if (s.freeModeMomentum) {
          ...
          if (y < t.maxTranslate())
            ...
            y = -(y =
              Math.abs(d[C] - y) < Math.abs(d[C - 1] - y) || "next" === t.swipeDirection ? d[C] : d[C - 1])
          }
          if (
            (T &&
      ...
      updateSize: function () {
        if (this.params.scrollbar.el && this.scrollbar.el) {
          ...
          var s,
            ...
            o = r * (a / this.size)
          ;(s =
            "auto" === this.params.scrollbar.dragSize ? a * r : parseInt(this.params.scrollbar.dragSize, 10)),
        ...
        for (var u = 0; u < a.length; u += 1) {
          ...
          if (
            ...
            0 === E.length &&
              ...
              0 === S.length &&
                ((S = s('<div class="swiper-slide-shadow-' + (h ? "right" : "bottom") + '"></div>')),
                v.append(S)),
    ...
    ge = {
      setTranslate: function () {
        for (
          ...
          var E =
            "translate3d(" + T + "px," + x + "px," + y + "px)  rotateX(" + w + "deg) rotateY(" + b + "deg)"
          if ((f.transform(E), (f[0].style.zIndex = 1 - Math.abs(Math.round(g))), n.slideShadows)) {
            var S = l ? f.find(".swiper-slide-shadow-left") : f.find(".swiper-slide-shadow-top"),
              C = l ? f.find(".swiper-slide-shadow-right") : f.find(".swiper-slide-shadow-bottom")
            0 === S.length &&
              ((S = s('<div class="swiper-slide-shadow-' + (l ? "left" : "top") + '"></div>')), f.append(S)),
              0 === C.length &&
                ((C = s('<div class="swiper-slide-shadow-' + (l ? "right" : "bottom") + '"></div>')),
                f.append(C)),
